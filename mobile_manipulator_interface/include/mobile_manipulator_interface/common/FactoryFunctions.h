...
MobileManipulatorInfo createMobileManipulatorInfo(const ocs2::PinocchioInterface& interface,
                                                  const ControllerSettings& controllerSettings);

ControllerSettings creatControllerSetting(const std::string& taskFile, const std::string& libraryFolder,
