...
struct CollisionSphere
{
  ...
  CollisionSphere(const std::string& name, const std::string& parent_frame_name, const Vec3<Scalar>& offset,
                  const Scalar radius)
    : name(name), parent_frame_name(parent_frame_name), offset(offset), radius(radius)
  {
  }
