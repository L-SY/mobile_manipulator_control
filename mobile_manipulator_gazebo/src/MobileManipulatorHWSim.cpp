#include "mobile_manipulator_gazebo/MobileManipulatorHWSim.h"
#include <gazebo_ros_control/gazebo_ros_control_plugin.h>

namespace MobileManipulator
{
bool MobileManipulatorHWSim::initSim(const std::string& robot_namespace, ros::NodeHandle model_nh,
...
void MobileManipulatorHWSim::readSim(ros::Time time, ros::Duration period)
{
...
void MobileManipulatorHWSim::parseImu(XmlRpc::XmlRpcValue& imuDatas, const gazebo::physics::ModelPtr& parentModel)
{
...
PLUGINLIB_EXPORT_CLASS(MobileManipulator::MobileManipulatorHWSim, gazebo_ros_control::RobotHWSim)
